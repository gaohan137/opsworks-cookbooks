...
default[:custom_layers][:unicorn_layer_custom][:opsworks_bundler][:manage_package] = true
default[:custom_layers][:unicorn_layer_custom][:apps] = ['unicorn_custom1']
default[:custom_layers][:unicorn_layer_custom][:layer_type] = 'rails-app'
default[:custom_layers][:unicorn_layer_custom][:rails_stack][:name] = 'nginx_unicorn'
